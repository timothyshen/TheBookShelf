    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.UUIDField(default=uuid.UUID('da672a9c-a95a-431a-892b-e6f32ed049b7'), editable=False, unique=True, verbose_name='Public identifier')),
                ...
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'Reader'), (4, 'Admin'), (2, 'Author'), (3, 'Editor')], default=1, null=True, verbose_name='Role')),
