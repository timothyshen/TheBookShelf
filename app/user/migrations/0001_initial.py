    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uid', models.UUIDField(default=uuid.UUID('56fc261b-d2cb-4b29-bf59-fc7cb439b9bd'), editable=False, unique=True, verbose_name='Public identifier')),
                ...
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(3, 'Editor'), (4, 'Admin'), (2, 'Author'), (1, 'Reader')], default=1, null=True, verbose_name='Role')),
